      ...
      <article>
        <div className="xl:divide-y xl:divide-gray-700">
          ...
          <div className="grid-rows-[auto_1fr] divide-y divide-gray-700 pb-8 xl:grid xl:grid-cols-4 xl:gap-x-6 xl:divide-y-0">
            <dl className="border-gray-700 pt-6 pb-10 xl:border-b xl:pt-11">
            ...
            <footer>
              <div className="divide-gray-700 text-sm leading-5 font-medium xl:col-start-1 xl:row-start-2 xl:divide-y">
                {tags && (
                  ...
                  <div className="flex justify-between py-4 xl:block xl:space-y-8 xl:py-8">
                    {prev && prev.path && (
                      <div>
                        ...
                        <div className="text-primary-500 hover:text-primary-400 !no-underline">
