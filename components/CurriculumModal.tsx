              ...
              >
                <DialogPanel className="w-full max-w-md transform overflow-hidden rounded-2xl border border-gray-700 bg-gray-900 p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="mt-4 flex gap-4">
                    <Link
                      href="/survey"
                      className="inline-flex justify-center rounded-md border border-transparent bg-blue-600 px-4 py-2 text-sm font-medium !text-white !no-underline hover:bg-blue-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
                      onClick={closeModal}
                    >
                      Go to survey
                    </Link>
