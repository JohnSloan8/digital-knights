...
I ran the Webwise page for the Switched On project through [Google's PageSpeed Insights tool](https://pagespeed.web.dev/). This is a tool commonly used by technical teams to perform basic checks on performance before publishing online. A performance score of 90 and a pass on the core vitals is the minimum a developer should be aiming for. The Webwise site failed.
