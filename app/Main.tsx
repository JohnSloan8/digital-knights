  ...
  return (
    <>
      ...
      <div className="relative z-10 mx-auto mt-[calc(100svh-64px)] w-full md:mt-[calc(100svh-96px)]">
        <div className="py-2 backdrop-blur-sm">
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-0 md:grid-cols-2 md:gap-8">
            <Quote>
              <p className="mb-2 text-lg font-light text-blue-100 italic md:text-xl">
        ...
        <div className="container mx-auto py-12">
          <h2 className="mt-0 mb-4 text-2xl leading-8 font-bold tracking-tight text-gray-100 md:mt-8">
            Introduction
          </h2>
